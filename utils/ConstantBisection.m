function eta = ConstantBisection(P, w)
    ...
    B_start = computeB(ConstantBounds(eta_start, P, w));
    B_end = computeB(ConstantBounds(eta_end, P, w));
    ...
    for n = 1:max_iter
        ...
        B_eta = computeB(ConstantBounds(eta, P, w));
