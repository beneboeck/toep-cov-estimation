function [Cov_est,win_length] = hyparaTuningTapering(X,P,N,sCov,N_a,cv_factor)
    ...
    for wl = [1:N_a]
        ...
        for cv = [1:cv_factor]
            ...
            r = r + 1/cv_factor * norm(Tapering(wl-1,c_train,P) - sC_eval,'fro')^2;
            end
            risks(wl) = r;
